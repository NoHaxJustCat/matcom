...
datcom_case.nose_type = "POWER"; % CONE, OGIVE, POWER, HAACK, KARMAN
datcom_case.power = 0.4; % se power definire il coefficiente
...
datcom_case.ctrbody_length = 1.4; % lunghezza del corpo centrale (fusoliera) dopo il nose
...
datcom_case.x_le = [1.71]; % distanza dalla punta del nose per ogni singolo semi-span definito
datcom_case.sweep = [28.6];
...
datcom_case.l_max_upper = [0.3, 0.3]; % Frazione della corda dalla sezione del bordo d'attacco allo spessore massimo della superficie superiore. 
...
datcom_case.l_flat_upper = [0.4, 0.4]; % La frazione della corda di spessore costante, sezione superiore
